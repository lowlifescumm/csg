-- Cosmic Spiritual Guide Database Initialization for Render
...
SELECT 'Admin user created: admin@cosmicguide.com (password: admin123)' as admin_info;
SELECT 'Default credits: 1000' as credits_info;
