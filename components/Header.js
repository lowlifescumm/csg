      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16 md:h-20">
          <Link href="/" className="flex items-center space-x-3 group">
            ...
            <div className="flex flex-col"><span className="text-xl md:text-2xl font-bold bg-gradient-to-r from-purple-600 via-pink-600 to-blue-600 bg-clip-text text-transparent leading-tight">Cosmic Spiritual Guide</span>{user && (<span className="text-xs text-gray-500 hidden md:block leading-tight">Discover clarity through ancient wisdom</span>)}</div>
          </Link>
