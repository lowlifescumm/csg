      ...
      <div className="space-y-8">
        ...
        <div className="dashboard-card">
          <div className="section-header">
            <h2 className="section-title">Daily Guidance</h2>
            <p className="section-subtitle">Quick access to your daily cosmic insights - perfect for starting your day</p>
          </div>
          ...
          {/* Quick Tarot Buttons - Improved Hierarchy */}
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
            {/* Primary Action - Daily Tarot */}
            <button
              onClick={() => checkCreditsAndOpenTarot("daily", "daily")}
              className="action-primary bg-gradient-to-r from-blue-500 via-purple-500 to-pink-500 flex items-center justify-center gap-3 relative min-h-[60px] touch-target"
            >
            ...
            <button
              ...
              className="action-secondary bg-gradient-to-r from-pink-500 via-rose-500 to-red-500 flex items-center justify-center gap-3 relative min-h-[60px] touch-target"
            >
            ...
            <button
              ...
              className="action-secondary bg-gradient-to-r from-blue-500 via-indigo-500 to-purple-500 flex items-center justify-center gap-3 relative min-h-[60px] touch-target"
            >
        ...
        <div className="dashboard-card">
          <div className="section-header">
            ...
            <p className="section-subtitle">Comprehensive readings and analyses to deepen your spiritual understanding</p>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
            ...
            <Link
              ...
              className="interactive-card bg-gradient-to-r from-purple-500 via-pink-500 to-orange-500 text-white p-6 rounded-2xl font-semibold apple-shadow-lg text-center min-h-[120px] flex flex-col items-center justify-center gap-3 relative"
            >
              <Star className="w-8 h-8" />
              <span>{hasBirthChart === true ? "My Birth Chart" : "Create Chart (Free)"}</span>
              {hasBirthChart === false && (
                <span className="credit-badge bg-green-500/80">Free</span>
              )}
              {hasBirthChart === true && (
                <span className="credit-badge">View</span>
              )}
            </Link>
            ...
            <Link
              href="/compatibility"
              className="interactive-card bg-gradient-to-r from-pink-500 via-rose-500 to-red-500 text-white p-6 rounded-2xl font-semibold apple-shadow-lg text-center min-h-[120px] flex flex-col items-center justify-center gap-3 relative"
            >
              <Heart className="w-8 h-8" />
              <span>Compatibility Report</span>
              <span className="credit-badge">5 Credits</span>
            </Link>

            {/* Moon Reading */}
            <Link
              href="/moon-reading"
              className="interactive-card bg-gradient-to-r from-indigo-500 via-blue-500 to-purple-500 text-white p-6 rounded-2xl font-semibold apple-shadow-lg text-center min-h-[120px] flex flex-col items-center justify-center gap-3 relative"
            >
              <Moon className="w-8 h-8" />
              <span>Moon Reading</span>
              <span className="credit-badge">2 Credits</span>
            </Link>

            {/* Breakup Tarot */}
            <button
              onClick={() => checkCreditsAndOpenTarot("breakup", "breakup", "TAROT_PREMIUM")}
              className="interactive-card bg-gradient-to-r from-red-500 via-pink-500 to-purple-500 text-white p-6 rounded-2xl font-semibold apple-shadow-lg text-center min-h-[120px] flex flex-col items-center justify-center gap-3 relative w-full"
            >
              <Heart className="w-8 h-8" />
            ...
            <button
              ...
              className="interactive-card bg-gradient-to-r from-purple-500 via-indigo-500 to-blue-500 text-white p-6 rounded-2xl font-semibold apple-shadow-lg text-center min-h-[120px] flex flex-col items-center justify-center gap-3 relative w-full"
            >
            ...
            <button
              ...
              className="interactive-card bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500 text-white p-6 rounded-2xl font-semibold apple-shadow-lg text-center min-h-[120px] flex flex-col items-center justify-center gap-3 border-2 border-white/30 w-full"
            >
              <Sparkles className="w-8 h-8" />
        ...
        {/* Section C: Cosmic Intelligence (Premium Dashboard) */}
        <div className="dashboard-card border-l-4 border-l-yellow-400 relative overflow-hidden">
          {/* Premium Badge */}
          ...
          <div className="mb-6">
            <div className="flex items-center gap-3 mb-2">
              ...
              <div className="section-header mb-0">
                <h2 className="section-title text-xl sm:text-2xl">Cosmic Intelligence</h2>
                <p className="section-subtitle">Advanced planetary analysis and AI-powered insights</p>
              </div>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            <Link
              ...
              className="interactive-card bg-gradient-to-r from-purple-600 via-pink-600 to-orange-600 text-white p-8 rounded-2xl font-semibold apple-shadow-lg relative overflow-hidden"
            >
              ...
              <div className="relative z-10">
                <div className="flex items-center gap-4 mb-4">
                  ...
                  <div>
                    <h3 className="text-2xl font-bold mb-1 flex items-center gap-2">
                      Transit Dashboard
                      {!isPremium && <span className="text-xs bg-yellow-400/30 px-2 py-1 rounded-full uppercase tracking-wide">Locked</span>}
                    </h3>
                    <p className="text-white/80 text-sm">Real-time planetary transits</p>
                  </div>
                </div>
                <p className="text-white/90 mb-4 font-normal leading-relaxed">
                ...
                <div className="flex items-center gap-2 text-yellow-300 font-semibold">
                  <span>{isPremium ? "View Dashboard" : "Upgrade to Access"}</span>
            ...
            <div className="bg-white/5 rounded-2xl p-8 border border-white/10 backdrop-blur-sm">
              ...
              <div className="flex flex-wrap gap-2">
                <span className="px-3 py-1 bg-purple-500/20 text-purple-200 text-xs font-semibold rounded-full border border-purple-500/30">Priority Processing</span>
                <span className="px-3 py-1 bg-pink-500/20 text-pink-200 text-xs font-semibold rounded-full border border-pink-500/30">Enhanced Detail</span>
                <span className="px-3 py-1 bg-orange-500/20 text-orange-200 text-xs font-semibold rounded-full border border-orange-500/30">Personalized</span>
              </div>
            </div>
          </div>

          {!isPremium && (
            <div className="mt-6 p-1 bg-gradient-to-r from-yellow-500/30 to-orange-500/30 rounded-2xl">
              <div className="bg-purple-900/80 backdrop-blur-md rounded-xl p-4 sm:p-6 text-center">
                <p className="text-yellow-200 text-sm sm:text-base mb-4">
                  <strong>Premium Feature:</strong> Unlock unlimited access to Transit Dashboard and priority AI interpretations
                </p>
                <Link
                  href="/subscription"
                  className="action-secondary bg-gradient-to-r from-yellow-500 to-orange-500 w-full sm:w-auto inline-flex items-center justify-center gap-2"
                >
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6 mb-8">
          <div className="stat-card">
            <div className="flex items-center gap-3 sm:gap-4">
              <div className="stat-icon bg-gradient-to-br from-blue-500 to-purple-500">
          ...
          <div className="stat-card">
            <div className="flex items-center gap-3 sm:gap-4">
              ...
              <div className="min-w-0 flex-1">
                ...
                <p className="stat-value">{readingCount + chartCount}</p>
              </div>
            </div>
          </div>
          ...
          {safeStreak && safeStreak.currentStreak > 0 && (
            <div className="stat-card">
              <div className="flex items-center gap-3 sm:gap-4">
                <div className="stat-icon bg-gradient-to-br from-pink-500 to-orange-500">
                  <Zap className="w-5 h-5 sm:w-6 sm:h-6 text-white" />
                </div>
                <div className="min-w-0 flex-1">
                  <p className="stat-label">Streak</p>
                  <p className="stat-value">{safeStreak.currentStreak} days</p>
                </div>
              </div>
            </div>
          )}
