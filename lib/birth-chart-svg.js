...
const safeParseJSON = (value, fallback = null, label = 'value') => {
  ...
  try {
    ...
    console.error(`${logPrefix} Failed to parse ${label}:`, error);
    return fallback;
  }
};
...
export function generateBirthChartSVG(chartData, birthInfo = {}) {
  ...
  return `
<svg viewBox="0 0 1000 800" preserveAspectRatio="xMidYMid meet" xmlns="http://www.w3.org/2000/svg" style="background: white; width: 100%; height: auto; max-width: 100%; print-color-adjust: exact; -webkit-print-color-adjust: exact;">
  <defs>
    <style>
