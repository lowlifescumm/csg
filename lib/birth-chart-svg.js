...
export function generateBirthChartSVG(chartData, birthInfo = {}) {
  ...
  return `
<svg width="1000" height="800" viewBox="0 0 1000 800" preserveAspectRatio="xMidYMid meet" xmlns="http://www.w3.org/2000/svg" style="background: white; max-width: 100%; height: auto;">
  <defs>
    <style>
