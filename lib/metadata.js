...
export const PAGE_METADATA = {
  home: {
    title: "AI Tarot Readings & Astrology | Free Daily Insights",
    description: "Experience AI-powered tarot readings and astrology insights. Get personalized spiritual guidance using advanced AI technology. 3 free credits daily. No appointments needed.",
    path: "/",
    keywords: [
      "AI tarot reading",
      "AI astrology",
  ...
  reading: {
    title: "Free Tarot Reading - AI Spiritual Guidance",
    description: "Get your free tarot reading instantly. Personalized AI interpretation for love, career, and life questions. No signup required for first reading.",
    path: "/reading",
    keywords: ["free tarot", "tarot reading", "online tarot", "AI tarot", "instant tarot"],
  },
  site: {
    title: "Cosmic Spirit Guide | AI Tarot & Astrology",
    description: "Personalized tarot readings and astrology insights providing spiritual guidance through advanced AI technology.",
    path: "/",
    keywords: ["tarot", "astrology", "AI reading", "spiritual guide"],
  },
};
