...
export const PAGE_METADATA = {
  home: {
    title: "Tarot Insights Today",
    description: "Discover daily tarot and astrology insights powered by AI. Get accurate, personalized guidance with 3 free credits every day.",
    path: "/",
