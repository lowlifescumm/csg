...
const MODEL_MAP = {
  'gpt-4o-mini': 'openai/gpt-oss-20b',         // Fast, cheap (replaces Llama 3.1 8B)
  'gpt-4o': 'llama-3.3-70b-versatile',         // Higher quality
...
function getGroqModel(openaiModel) {
  return MODEL_MAP[openaiModel] || 'openai/gpt-oss-20b';
}

/**
 * Generate a tarot reading using Groq (GPT OSS 20B).
...
`
  ...
  // Groq API (GPT OSS 20B - fast and cheap)
