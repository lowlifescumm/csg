  ...
  <style>
    ...
    * {
    ...
    .page-inner {
      width: 100%;
      margin: 0 auto;
      padding-top: 1.25in; /* Increased from implicit spacing - pushes content down from header */
      padding-bottom: 1.25in; /* Increased from implicit spacing - pushes content up from footer */
    }
