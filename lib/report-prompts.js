...
Synthesize how Sun, Moon, and Rising interact based on their signs and houses. Explain the unique identity they create together. Provide comprehensive analysis of how these three core placements work together or create tension.
...
export function getDestinyPathPrompt(data) {
  ...
  if (age !== null) {
    if ((age >= 28 && age <= 30) || (age >= 58 && age <= 60)) {
      ...
      // Saturn Opposition (Midlife Crisis)
...
- North Node: ${northNodeSign} in the **${northNodeHouseName || formatOrdinal(northNodeHouse) || 'Unknown House'}**

- South Node: ${southNodeSign} in the **${southNodeHouseName || formatOrdinal(southNodeHouse) || 'Unknown House'}**
...
Provide comprehensive explanation of what the North Node and South Node represent. Reference the user's specific placements: North Node in ${northNodeSign} in the ${northNodeHouseName || formatOrdinal(northNodeHouse) || 'Unknown House'} and South Node in ${southNodeSign} in the ${southNodeHouseName || formatOrdinal(southNodeHouse) || 'Unknown House'}. Give thorough context about the nodal axis and its significance in the user's chart.
