...
**MANDATORY CONSTRAINT: DO NOT say the partner is unknown, unspecified, or mysterious. The partner's signs are explicitly provided: ${partnerSunSign} Sun and ${partnerMoonSign} Moon. Write a specific, detailed analysis based on the interaction between ${userSunSign} (User) and ${partnerSunSign} (Partner).**

**ANALYSIS REQUIREMENT:**
Analyze the relationship between a ${userSunSign} (User) and a ${partnerSunSign} (Partner). The Partner also has a ${partnerMoonSign} Moon. Reference these specific signs throughout your analysis.`
    : '';
