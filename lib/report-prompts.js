...
Provide comprehensive explanation of what the North Node and South Node represent. Reference the user's specific placements: North Node in ${northNodeSign} in the ${northNodeHouseName || `${northNodeHouse || 'Unknown'}th House`} and South Node in ${southNodeSign} in the ${southNodeHouseName || `${southNodeHouse || 'Unknown'}th House`}. Give thorough context about the nodal axis and its significance in the user's chart.
