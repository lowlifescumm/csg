...
<body>
  ...
  console.log(`[Premium PDF Generator] Using report type: ${reportType}, title: ${reportTitle}, sections: ${sections.length}`);
  ...
  try {
    ...
    console.warn('[Premium PDF Generator] Puppeteer launch failed, trying Playwright:', launchError.message);
    if (pw) {
      try {
        ...
        console.log('[Premium PDF Generator] Playwright browser launched successfully');
      } catch (pwError) {
        console.error('[Premium PDF Generator] Playwright launch also failed:', pwError.message);
        throw launchError;
      }
    } else {
      throw launchError;
