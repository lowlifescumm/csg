    ...
    for (const section of sections) {
      try {
        ...
        if (!sectionHtml || sectionHtml.trim().length < 100) {
          console.log(`[Premium PDF Generator] Skipping ${section.label} - no content`);
          continue;
        }
        ...
        // 3. Set content on the Puppeteer page
        await page.setContent(fullSectionHtml, { waitUntil: 'networkidle0' });
        ...
        console.error(`[Premium PDF Generator] Error rendering section ${section.label}:`, sectionError);
