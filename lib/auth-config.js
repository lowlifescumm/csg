...
if (!NEXTAUTH_URL) {
  ...
  console.log('[NextAuth] NEXTAUTH_URL is set to:', NEXTAUTH_URL);
}
...
if (!GOOGLE_CLIENT_ID || !GOOGLE_CLIENT_SECRET) {
  ...
  console.error('[NextAuth] AUTH WILL NOT WORK — set GOOGLE_CLIENT_ID and GOOGLE_CLIENT_SECRET in Render dashboard');
}
...
console.log('[NextAuth] Creating NextAuth authOptions...');
