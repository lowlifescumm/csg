...
/**
 * Generates a personalized tarot reading using the OpenAI API.
 * @param {Array<object>} cards - An array of card objects, each with 'name' and 'reversed' properties.
 * @param {string} question - The user's question for the reading.
 * @param {string} [spread="three-card"] - The type of tarot spread used.
 * @param {string} [readingType="general"] - The type of reading (e.g., 'love', 'career').
 * @returns {Promise<string>} The AI-generated tarot reading.
 */
...
/**
 * Generates a concise summary of a tarot reading.
 * @param {string} fullText - The full text of the tarot reading.
 * @returns {Promise<string|undefined>} A 1-2 sentence summary of the reading.
 */
...
/**
 * Creates a vector embedding for a given text using OpenAI's embedding model.
 * @param {string} text - The text to create an embedding for.
 * @returns {Promise<Array<number>|undefined>} The vector embedding.
 */
...
/**
 * Generates a coaching reply based on past readings and a new input.
 * @param {object} params - The parameters for generating the reply.
 * @param {Array<string>} [params.pastSummaries=[]] - Summaries of past readings.
 * @param {string} params.newCard - The new card drawn.
 * @param {string} params.question - The user's question.
 * @returns {Promise<string|undefined>} The AI-generated coaching reply.
 */
